...
public class LiJianExecutor extends AbstractExecutor implements RuleExecutor {
    ...
    public SettlementInfo computeRule(SettlementInfo settlement) {
        ...
        // 2、sum-quota 判断是否大于最小支付费用，否则返回最小支付费用
        ...
        settlement.setCost((retain2Decimals(sum-quota) < minCost()) ? minCost() : retain2Decimals(sum-quota));
        log.debug("Use liJian From coupon {} to user {}", couponAndTemplateInfo.getId(), settlement.getUserId());
        return settlement;
    }
}
